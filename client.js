...
function createGame() {
    ...
    function gravity(body1, body2, i) {

        if(!i) {
            body1.acelerationx = body2.acelerationx = body1.acelerationy = body2.acelerationy = 0
        }
    ...
    createRetangle({ mass: 10000000, color: 'red', x: 50, y: 200, width: 30, height: 70 })
    createRetangle({ mass: 80000000000000, color: 'yellow', x: 400, y: 100, width: 200, height: 170 })
    createRetangle({ mass: 50000000, color: 'red', x: 200, y: 300, width: 50, height: 75 })
    createCircle({ color: 'brown', mass: 4000000000, x: 800, y: 80, radius: 70, speedx: -7 })
    createCircle({ color: 'purple', mass: 80000000000000, x: 50, y: 500, radius: 70, speedx: 3 })
